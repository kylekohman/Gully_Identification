...
def predict(image_path, generator, size=256):
    ...
    with Image.open(image_path) as img:
        ...
        blank_image.show()
        blank_image.save("D:/USERS/KYLE_KOHMAN/GAN/outputs/full_images/" + image_name + "_mark.png")

gen = load_model("gan_cpu.h5")
image_path = "images/satellites/RGB/322_rgb.png"
